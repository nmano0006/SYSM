...
struct HexBase64CalculatorView: View {
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showDonationInfo) {
            DonationInfoView()
        }
    }
    ...
    private var headerSection: some View {
        VStack(spacing: 8) {
            ...
            Text("Version 1.1 • Convert between different encoding formats")
                .font(.subheadline)
    ...
    private var informationSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            // Use the CalculatorInfoRow struct here
    ...
    private var DeveloperInfoSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            SectionHeader(title: "Developer Information", icon: "person.circle.fill")
            
            VStack(alignment: .leading, spacing: 12) {
                // Use the renamed method here
                DeveloperInfoRow(label: "Developer:", value: "Navaratnam Manoranjan")
                DeveloperInfoRow(label: "Email:", value: "nmano0006@gmail.com")
                DeveloperInfoRow(label: "Application:", value: "Hex/Base64 Calculator")
                DeveloperInfoRow(label: "Version:", value: "1.1") // Updated to version 1.1
                ...
                HStack {
                    ...
                    Link("nmano0006@gmail.com", destination: URL(string: "mailto:nmano0006@gmail.com")!)
                        .foregroundColor(.blue)
                ...
                HStack {
                    ...
                    Button(action: { showDonationInfo = true }) {
                        HStack {
                ...
                HStack {
                    ...
                    Text("For issues or suggestions, please contact the developer.")
                        .font(.caption)
                        .foregroundColor(.secondary)
    ...
    // MARK: - Developer Info Row Component (Renamed to avoid conflict)
    private func DeveloperInfoRow(label: String, value: String) -> some View {
    ...
    // MARK: - Donation Info View
    private struct DonationInfoView: View {
        ...
        var body: some View {
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    Text("Thank you for using Hex/Base64 Calculator!")
                        .font(.headline)
                    
                    Text("This application is completely free and open-source. Your support helps fund:")
                        .font(.body)
                    
                    VStack(alignment: .leading, spacing: 8) {
                        Label("Testing devices and hardware", systemImage: "desktopcomputer")
                        Label("Server costs and hosting", systemImage: "server.rack")
                        Label("Ongoing maintenance and updates", systemImage: "arrow.triangle.2.circlepath")
                        Label("New feature development", systemImage: "sparkles")
                    }
                    .font(.caption)
                    .padding(.leading, 8)
                }
                ...
                VStack(spacing: 16) {
                    Link(destination: URL(string: "https://www.paypal.com/donate/?business=H3PV9HX92AVMJ&no_recurring=0&item_name=Support+my+open-source+development+work.+Donations+help+fund+testing+devices%2C+server+costs%2C+and+ongoing+maintenance+for+all+my+projects.&currency_code=CAD")!) {
                        HStack {
                            Image(systemName: "creditcard.fill")
                                .font(.title2)
                            ...
                            VStack(alignment: .leading) {
                                Text("Donate via PayPal")
                                    .font(.headline)
                                Text("Click to open PayPal donation page")
                                    .font(.caption)
                                    .foregroundColor(.secondary)
                            }
                    ...
                    Text("Any amount is appreciated! ❤️")
                        .font(.caption)
                        .foregroundColor(.secondary)
                }
                ...
                VStack(spacing: 8) {
                    Text("Alternative ways to support:")
                        .font(.caption)
                        .fontWeight(.medium)
                    
                    HStack {
                        Link("GitHub Sponsors", destination: URL(string: "https://github.com/sponsors")!)
                            .font(.caption)
                        
                        Text("•")
                            .foregroundColor(.secondary)
                        
                        Link("Buy Me a Coffee", destination: URL(string: "https://buymeacoffee.com")!)
                            .font(.caption)
...
// MARK: - Calculator Info Row Component (This is a struct)
