...
struct HexBase64CalculatorView: View {
    ...
    private var informationSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            InfoRow(title: "Hex", description: "Base-16 encoding using 0-9 and A-F (case insensitive)")
            InfoRow(title: "Base64", description: "64-character encoding using A-Z, a-z, 0-9, +, /, and = padding")
            InfoRow(title: "Decimal", description: "Base-10 representation of ASCII values (space separated)")
            InfoRow(title: "Binary", description: "Base-2 representation (8 bits per character, space separated)")
            InfoRow(title: "ASCII", description: "American Standard Code for Information Interchange (0-127)")
        }
        .padding()
        .background(Color(.controlBackgroundColor))
        .cornerRadius(12)
