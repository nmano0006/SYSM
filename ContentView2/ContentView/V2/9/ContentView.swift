...
struct ContentView: View {
    ...
    private func checkPermissions() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
            // Check Full Disk Access using ShellHelper
            hasFullDiskAccess = ShellHelper.checkFullDiskAccess()
...
// MARK: - Helper Methods (Removed from top level - now properly in ShellHelper)
// These methods should only exist in ShellHelper.swift, not here
