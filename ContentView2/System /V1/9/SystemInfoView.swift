...
struct SystemInfoView: View {
    ...
    private func exportSystemInfo() async {
        isExporting = true
        ...
        // Create the document
        let document = TextDocument(text: exportText)
        ...
        let result = await savePanel.beginSheetModal(for: NSApp.keyWindow!)
        ...
        if result == .OK, let url = savePanel.url {
            do {
                ...
                exportErrorMessage = "Failed to write file: \(error.localizedDescription)"
