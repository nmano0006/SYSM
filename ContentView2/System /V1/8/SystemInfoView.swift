...
struct SystemInfoView: View {
    ...
    var body: some View {
        ...
        .fileExporter(
            ...
            document: TextDocument(text: generateExportText()),
    ...
    // ... [Previous UI code remains the same - all the UI sections] ...
    // Let me include a shortened version for clarity:
    ...
    // ... [Other UI sections: SoftwareInfoSection, StorageInfoSection, NetworkInfoSection, DetailedSystemInfoSection remain the same] ...
