...
struct SystemInfoView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: 20) {
                ...
                // NEW: Detailed System Information
    ...
    // NEW: Detailed System Information Section
    ...
    private func refreshSystemInfo() {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            // NEW: Get detailed system information
            ...
            // Get serial info details (these would need custom parsing based on your serial number format)
            ...
            // iMessage keys (placeholder values - these would typically come from NVRAM)
