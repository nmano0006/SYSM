...
struct LoadingLogoView: View {
    ...
    private func startAnimations() {
        ...
        // Pulsing animation (only if showBackground is true)
        if showBackground {
            withAnimation(
    ...
    var body: some View {
        if isVisible {
            ZStack {
                ...
                // Loading content
                VStack(spacing: 20) {
                    LoadingLogoView(size: 80, color: .white, showBackground: true)
...
// Loading progress view with percentage
...
struct LoadingLogoView_Previews: PreviewProvider {
    static var previews: some View {
        VStack(spacing: 30) {
            ...
            LoadingOverlayView(message: "Loading...", isVisible: true)
