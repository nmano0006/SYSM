...
struct SSDTGeneratorView: View {
    ...
    private let authorName = "Navaratnam Manoranjan"
    private let authorEmail = "nmano0006@gmail.com"
    private let appVersion = "2.7.8.1.0"
    private let appName = "SystemMaintenance SSDT Generator"
    ...
    private var footerSection: some View {
        VStack(alignment: .center, spacing: 8) {
            ...
            HStack(spacing: 4) {
                ...
                Button(action: {
                    let email = "mailto:\(authorEmail)?subject=SSDT%20Generator%20Feedback"
            ...
            Text("© \(Calendar.current.component(.year, from: Date())) \(appName)")
                .font(.caption2)
                .foregroundColor(.secondary)
        }
        .padding(.top)
    ...
    private func generateGenericSSDT(for ssdt: String) -> String {
        ...
        /*
         * \(ssdt).dsl
         * Generated by SystemMaintenance SSDT Generator
    ...
    private func saveSSDTsToFolder(at url: URL) {
        Task {
            ...
            do {
                // Get all generated files from the output directory
                let files = try fileManager.contentsOfDirectory(atPath: outputDir)
                ...
                // Create a README file with generation info
                let readmeContent = """
                # Generated SSDTs
                ...
                • Generated using SystemMaintenance SSDT Generator
                """
