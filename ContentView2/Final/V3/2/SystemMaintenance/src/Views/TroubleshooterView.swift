...
struct TroubleshooterView: View {
        ...
        ScrollView {
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("The troubleshooter is designed to diagnose and fix common macOS system issues. If you encounter persistent problems, contact the developer for assistance.")
                        .font(.caption)
                        .foregroundColor(.secondary)
                    ...
                    HStack(spacing: 10) {
                        ...
                        Link(destination: URL(string: "https://stackoverflow.com")!) {
    ...
    struct EnhancedDeveloperDetailsView: View {
        var body: some View {
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text("The troubleshooter uses advanced diagnostic algorithms to identify and resolve system issues. It's regularly updated to support the latest macOS versions.")
                    .font(.caption)
                    .foregroundColor(.secondary)
                    .padding(.top, 5)
            }
    ...
    struct AdditionalContactOptionsView: View {
        ...
        private func reportBug() {
            ...
            let subject = "[SYSM Troubleshooter] Bug Report"
            let body = """
            Bug Report for SYSM Troubleshooter v2.7.8.1.0
        ...
        private func requestFeature() {
            let email = "nmano0006@gmail.com"
            let subject = "[SYSM Troubleshooter] Feature Request"
            let body = """
            Feature Request for SYSM Troubleshooter
        ...
        private func showDonationOptions() {
            ...
            alert.informativeText = "If you find this tool helpful, consider supporting further development. You can send support via PayPal to nmano0006@gmail.com"
        ...
        private func copyDeveloperFullProfile() {
            ...
            // Haptic feedback - FIXED: Using .generic instead of .success for compatibility
    ...
    private func sendEmailFeedback() {
        let email = "nmano0006@gmail.com"
        let subject = "SYSM Troubleshooter Feedback"
        let body = """
        Hello Developer,
        
        Here's my feedback about the SYSM Troubleshooter (v2.7.8.1.0):
    ...
    private func copyContactInfo() {
        ...
        Email: nmano0006@gmail.com
        Specialization: macOS System Diagnostics & Optimization
        Tool: SYSM Troubleshooter v2.7.8.1.0
        """
        
        NSPasteboard.general.clearContents()
        NSPasteboard.general.setString(contactInfo, forType: .string)
        
        // Provide haptic feedback - FIXED: Using .generic instead of .success for compatibility
        NSHapticFeedbackManager.defaultPerformer.perform(.generic, performanceTime: .now)
    }
}
