...
struct SystemInfoView: View {
    ...
    private var DeveloperInfoSection: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                InfoRow(label: "Application:", value: "OpenCore Configurator")
    ...
    private func createExportContent() {
        ...
        exportContent += "Application: OpenCore Configurator\n"
        exportContent += "Version: 2.7.8.1.0\n"
        exportContent += "Copyright © \(Calendar.current.component(.year, from: Date())) Navaratnam Manoranjan\n"
