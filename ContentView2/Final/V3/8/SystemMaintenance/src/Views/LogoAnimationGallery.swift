...
struct LogoAnimationGallery: View {
    ...
    private var informationSection: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 8) {
                AnimationInfoRow(title: "Shake:", description: "Random directional shaking effect")
                AnimationInfoRow(title: "Rotate:", description: "Continuous 360° rotation")
                AnimationInfoRow(title: "Pulse:", description: "Rhythmic scaling animation")
                AnimationInfoRow(title: "Earthquake:", description: "Intense random shaking")
                AnimationInfoRow(title: "Interactive:", description: "Hover-sensitive scaling")
                AnimationInfoRow(title: "Dark Mode:", description: "Theme-adaptive appearance")
                AnimationInfoRow(title: "Enhanced:", description: "Combined rotation and scaling")
                AnimationInfoRow(title: "Loading:", description: "Continuous rotation for loading states")
            }
...
// MARK: - Animation Info Row Component (Renamed to avoid conflict)
