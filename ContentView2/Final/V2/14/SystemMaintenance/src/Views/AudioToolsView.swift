...
struct AudioToolsView: View {
    ...
    // MARK: - Developer Information Card
    ...
    private func setOutputDevice(_ device: AudioDevice) {
        ...
        if result.success {
            ...
            alertMessage = "Failed to set output device: Unknown error"
        }
        showAlert = true
        refreshAudioDevices()
    }
    ...
    private func testMicrophone() {
        ...
        ---
        Audio Tools by Navaratnam Manoranjan (nmano0006@gmail.com)
        """
        showAlert = true
    }
    ...
    private func generateAudioReport() {
        ...
        report += "Tool: SystemMaintenance Audio Tools\n"
        ...
        // Developer information at the end
        report += "\n\n=== Developer Information ===\n"
        report += "Tool: Audio Tools Module\n"
        report += "Developer: Navaratnam Manoranjan\n"
        report += "Email: nmano0006@gmail.com\n"
        report += "GitHub: github.com/nmano\n"
        report += "Support: Donations welcome via PayPal\n"
