...
struct SSDTGeneratorView: View {
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    HStack(spacing: 20) {
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            .pickerStyle(.menu)
                            .frame(width: 180)
                            .onChange(of: selectedDeviceType) {
    ...
    private func generateSSDTs() {
            // Warn about iasl if compilation is enabled but not available
            if includeCompilation {
                ...
                if !iaslCheck.success {
                    ...
                    // User will need to manually continue after seeing the alert
                    // For now, we'll disable compilation and continue
