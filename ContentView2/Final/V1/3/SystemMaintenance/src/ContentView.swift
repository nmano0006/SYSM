...
struct ContentView: View {
    ...
    var body: some View {
        TabView(selection: $selectedTab) {
            ...
            // Tab 3: Kexts Manager
            KextsManagerView()
                .tabItem { Label("Kexts", systemImage: "puzzlepiece") }
                .tag(2)
                .toolbar {
                    ToolbarItem(placement: .principal) {
                        HStack(spacing: 12) {
            ...
            SSDTGeneratorView(showAlert: $showAlert, alertTitle: $alertTitle, alertMessage: $alertMessage)
                .tabItem { Label("SSDT", systemImage: "gear") }
                .tag(4)
                .toolbar {
                    ToolbarItem(placement: .principal) {
                        HStack(spacing: 12) {
            ...
            // Tab 8: Logo Animation Gallery (Optional - comment out if not needed)
            /*
            LogoAnimationGallery()
                .tabItem { Label("Logo Test", systemImage: "star") }
                .tag(7)
            */
        }
...
// MARK: - Troubleshooter View (Keep in same file)
...
// MARK: - Status Card for Troubleshooter
