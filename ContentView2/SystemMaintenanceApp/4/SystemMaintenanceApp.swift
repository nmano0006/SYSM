        ...
        ScrollView {
            VStack(spacing: 20) {
                ...
                InfoCard(title: "Security Status", icon: "lock.shield", color: .green) {
                    InfoRow(title: "SIP Status", value: getSIPStatus())
                    InfoRow(title: "Gatekeeper", value: getGatekeeperStatus())
                    InfoRow(title: "Firewall", value: getFirewallStatus())
                    InfoRow(title: "FileVault", value: getFileVaultStatus())
                }
                
                // Storage Info
                InfoCard(title: "Storage Status", icon: "internaldrive", color: .orange) {
                    InfoRow(title: "Boot Volume", value: getBootVolume())
                    InfoRow(title: "Total Space", value: getTotalStorage())
                    InfoRow(title: "Used Space", value: getUsedStorage())
                    InfoRow(title: "Free Space", value: getFreeStorage())
                }
                
                // Network Info
                InfoCard(title: "Network Information", icon: "network", color: .indigo) {
                    InfoRow(title: "Hostname", value: getHostname())
                    InfoRow(title: "IP Address", value: getIPAddress())
                    InfoRow(title: "MAC Address", value: getMACAddress())
                    InfoRow(title: "Network Services", value: getNetworkServicesCount())
                }
            }
            .padding()
        }
...
struct ToolsContentView: View {
    ...
    private func runTool(action: () -> (output: String, success: Bool)) {
        DispatchQueue.global(qos: .userInitiated).async {
            let result = action()
            DispatchQueue.main.async {
    ...
    private static func clearCache() -> (output: String, success: Bool) {
    ...
    private static func repairPermissions() -> (output: String, success: Bool) {
    ...
    private static func verifyDisk() -> (output: String, success: Bool) {
    ...
    private static func rebuildSpotlight() -> (output: String, success: Bool) {
    ...
    private static func flushDNS() -> (output: String, success: Bool) {
    ...
    private static func resetSMC() -> (output: String, success: Bool) {
        print("🔧 Resetting SMC...")
    ...
    private static func resetNVRAM() -> (output: String, success: Bool) {
