...
class ConfigStateManager: ObservableObject {
    ...
    // Add an initializer with default values
    init() {
        // Initialize with default values
        self.configData = [:]
        self.isEditing = false
        self.selectedSection = "ACPI"
        self.configEntries = []
        self.expandedEntries = []
        self.sectionDataCache = [:]
    }
    ...
    var body: some View {
        NavigationView {
            VStack(spacing: 0) {
                ...
                if showDebugInfo {
                    DebugInfoView(configData: configState.configData)
                        .padding(.horizontal, 8)
                        .padding(.bottom, 8)
                }
                        ...
                        VStack(alignment: .leading, spacing: 0) {
                            ...
                            ForEach(sections, id: \.self) { section in
                                if section == "---" {
                                    ...
                                    SectionRow(
                                        section: section,
                                        isSelected: configState.selectedSection == section,
            ...
            VStack(spacing: 0) {
                VStack(spacing: 0) {
                    HStack {
                        ...
                        .buttonStyle(.bordered)
                        .controlSize(.small)
                        .disabled(configState.configData.isEmpty)
                ...
                if configState.configData.isEmpty {
                    VStack(spacing: 20) {
                        Spacer()
