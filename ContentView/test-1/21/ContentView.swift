...
struct ShellHelper {
    ...
    static func getAllDrives() -> [DriveInfo] {
        ...
        // Method 3: If still empty, try system_profiler
        if drives.isEmpty {
            print("Text parsing failed, trying system_profiler...")
            drives = getDrivesFromSystemProfiler()
        }
        
        // Method 4: Last resort - check mounted volumes
        if drives.isEmpty {
    ...
    private static func parseTextDiskOutput(_ output: String) -> [DriveInfo] {
        ...
        var currentDisk: (identifier: String, name: String, size: String) = ("", "", "Unknown")
        ...
        for line in lines {
            ...
            if trimmedLine.hasPrefix("/dev/disk") && trimmedLine.contains(":") {
                ...
                if !currentDisk.identifier.isEmpty {
                    let isInternal = isDiskInternal(currentDisk.identifier)
                    drives.append(DriveInfo(
                ...
                if components.count >= 1 {
                    ...
                    if components.count >= 2 {
                        ...
                        if !description.isEmpty {
                            currentDisk.name = description.components(separatedBy: ",").first?.trimmingCharacters(in: .whitespaces) ?? ""
                        }
                    }
                }
                inDiskSection = true
            ...
            // Look for partitions (lines starting with numbers)
                ...
                if parts.count >= 5 {
                    ...
                    let isEFI = partType.contains("EFI") || partId.contains("s1")
...
struct ExportSystemInfoView: View {
    ...
    private func generateJSON() -> String {
        ...
        // Hardware Info
        json["hardware"] = [
            "gpuInfo": systemInfo.gpuInfo,
            "networkInfo": systemInfo.networkInfo,
            "storageInfo": systemInfo.storageInfo,
            "usbInfo": systemInfo.usbInfo,
            "thunderboltInfo": systemInfo.thunderboltInfo,
            "ethernetInfo": systemInfo.ethernetInfo,
            "nvmeInfo": systemInfo.nvmeInfo,
            "ahciInfo": systemInfo.ahciInfo,
            "audioInfo": systemInfo.audioInfo,
            "bluetoothInfo": systemInfo.bluetoothInfo,
            "pciDevices": systemInfo.pciDevices,
            "wirelessInfo": systemInfo.wirelessInfo,
            "usbXHCInfo": systemInfo.usbXHCInfo
        ]
        ...
        <body>
            <div class="container">
                ...
                <div class="section">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="value">\(systemInfo.processor)<br><small>\(systemInfo.processorDetails)</small></div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            <div class="label">Platform UUID</div>
                            <div class="value">\(systemInfo.platformUUID)</div>
                        </div>
                        <div class="info-item">
                ...
                <div class="hardware-section">
                    ...
                    <div class="hardware-item">\(systemInfo.gpuInfo)</div>
                    
                    <h3>Network Information</h3>
                    <div class="hardware-item">\(systemInfo.networkInfo)</div>
                    
                    <h3>Storage Controllers</h3>
                    <div class="hardware-item">\(systemInfo.storageInfo)</div>
                    
                    <h3>USB Information</h3>
                    <div class="hardware-item">\(systemInfo.usbInfo)</div>
                    
                    <h3>USB eXtensible Host-Controller</h3>
                    <div class="hardware-item">\(systemInfo.usbXHCInfo)</div>
                    
                    <h3>Thunderbolt Information</h3>
                    <div class="hardware-item">\(systemInfo.thunderboltInfo)</div>
                    
                    <h3>Ethernet Controller</h3>
                    <div class="hardware-item">\(systemInfo.ethernetInfo)</div>
                    
                    <h3>NVMe Controller</h3>
                    <div class="hardware-item">\(systemInfo.nvmeInfo)</div>
                    
                    <h3>AHCI/SATA Controller</h3>
                    <div class="hardware-item">\(systemInfo.ahciInfo)</div>
                    
                    <h3>Audio Information</h3>
                    <div class="hardware-item">\(systemInfo.audioInfo)</div>
                    
                    <h3>Bluetooth Information</h3>
                    <div class="hardware-item">\(systemInfo.bluetoothInfo)</div>
                    
                    <h3>PCI Devices</h3>
                    <div class="hardware-item">\(systemInfo.pciDevices)</div>
                    
                    <h3>Wireless Network Controller</h3>
                    <div class="hardware-item">\(systemInfo.wirelessInfo)</div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="info-grid">
                        <div class="info-item">
                            ...
                            <div class="value">\(allDrives.count)</div>
                        </div>
                        <div class="info-item">
                            <div class="label">Internal Drives</div>
                            <div class="value">\(allDrives.filter { $0.isInternal }.count)</div>
                        </div>
                        <div class="info-item">
                            <div class="label">External Drives</div>
                            <div class="value">\(allDrives.filter { !$0.isInternal }.count)</div>
                        </div>
                    </div>
                </div>
