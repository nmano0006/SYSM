...
struct ShellHelper {
    ...
    static func getCompleteSystemInfo() -> SystemInfo {
        ...
        // Processor Details
        let cpuCoresResult = runCommand("sysctl -n hw.ncpu")
        let cpuCores = cpuCoresResult.success ? cpuCoresResult.output.trimmingCharacters(in: .whitespacesAndNewlines) : "Unknown"
        let cpuThreadsResult = runCommand("sysctl -n machdep.cpu.thread_count")
        ...
        // System UUID
        let uuidResult = runCommand("system_profiler SPHardwareDataType | grep 'Hardware UUID' | awk '{print $3}'")
        info.systemUUID = uuidResult.success ? uuidResult.output.trimmingCharacters(in: .whitespacesAndNewlines) : "Unknown"
        
        // Boot ROM Version
        let bootROMResult = runCommand("system_profiler SPHardwareDataType | grep 'Boot ROM Version' | awk -F': ' '{print $2}'")
        info.bootROMVersion = bootROMResult.success ? bootROMResult.output.trimmingCharacters(in: .whitespacesAndNewlines) : "Unknown"
        
        // SMC Version
        let smcResult = runCommand("system_profiler SPHardwareDataType | grep 'SMC Version' | awk -F': ' '{print $2}'")
        info.smcVersion = smcResult.success ? smcResult.output.trimmingCharacters(in: .whitespacesAndNewlines) : "Unknown"
        
        // Serial Number
        let serialResult = runCommand("system_profiler SPHardwareDataType | grep 'Serial Number' | awk -F': ' '{print $2}'")
        info.serialNumber = serialResult.success ? serialResult.output.trimmingCharacters(in: .whitespacesAndNewlines) : "Unknown"
        
        // Platform UUID
        let platformUUIDResult = runCommand("ioreg -rd1 -c IOPlatformExpertDevice | grep IOPlatformUUID | awk -F'\"' '{print $4}'")
    ...
    static func getGPUInfo() -> String {
        let result = runCommand("""
        system_profiler SPDisplaysDataType | grep -E '(Chipset Model:|VRAM .Total:|Vendor:|Metal:|Displays:|Resolution:|Framebuffer Depth:|Mirror:|Online:)' | head -30
        """)
        ...
        ioreg -l | grep -i 'vendor-id\\|device-id\\|model\\|ATY\\|NVDA' | head -10
        """)
    ...
    static func getNetworkInfo() -> String {
        let result = runCommand("""
        system_profiler SPNetworkDataType | grep -E '(Type:|Hardware:|BSD Device Name:|IPv4 Addresses:|State:|Wi-Fi:|Ethernet:)' | head -40
        """)
    ...
    static func getStorageControllerInfo() -> String {
        let result = runCommand("""
        system_profiler SPSerialATADataType | grep -E '(Model:|Revision:|Physical Interconnect:|Negotiated Link Speed:|Bay Name:|Volumes:)' | head -25
        """)
        ...
        system_profiler SPNVMeDataType | grep -E '(Model:|Revision:|Link Width:|Link Speed:)' | head -10
        """)
    ...
    static func getUSBInfo() -> String {
        let result = runCommand("""
        system_profiler SPUSBDataType | grep -E '(Host Controller Location:|Vendor ID:|Product ID:|Speed:|Manufacturer:|Location ID:|Product Version:)' | head -40
        """)
    ...
    static func getThunderboltInfo() -> String {
        let result = runCommand("""
        system_profiler SPThunderboltDataType | grep -E '(Connected:|Device Name:|Vendor Name:|UID:|Firmware Version:|Port:|Status:)' | head -25
        """)
    ...
    static func getEthernetControllerInfo() -> String {
        let result = runCommand("""
        system_profiler SPNetworkDataType | grep -B3 -A3 'Ethernet' | grep -E '(Type:|Hardware:|BSD Name:|IPv4:|State:)' | head -20
        """)
        ...
        ifconfig | grep -E '^(en[0-9]|eth[0-9])' | head -5
        """)
    ...
    static func getNVMeControllerInfo() -> String {
        let result = runCommand("""
        system_profiler SPNVMeDataType | grep -E '(Model:|Revision:|Link Width:|Link Speed:|Capacity:|Physical Interconnect:)' | head -15
        """)
        ...
        diskutil list | grep -i 'nvme' | head -5
        """)
    ...
    static func getAHCIControllerInfo() -> String {
        let result = runCommand("""
        system_profiler SPSerialATADataType | grep -i 'AHCI\\|SATA' | head -10
        """)
        ...
        let ioregResult = runCommand("""
        ioreg -p IODeviceTree -n SATA -r | grep -i 'class\\|name' | head -5
        """)
    ...
    static func getAudioInfo() -> String {
        let result = runCommand("""
        system_profiler SPAudioDataType | grep -E '(Default Output Device:|Default System Output Device:|Manufacturer:|Output Source:|Sample Rate:)' | head -15
        """)
    ...
    static func getBluetoothInfo() -> String {
        let result = runCommand("""
        system_profiler SPBluetoothDataType | grep -E '(Apple Bluetooth Software Version:|State:|Discoverable:|Connectable:|Address:|Name:)' | head -15
        """)
    ...
    static func getPCIDevices() -> String {
        let result = runCommand("""
        system_profiler SPPCIDataType | grep -E '(Name:|Type:|Driver Installed:|Link Width:|Link Speed:|Slot:)' | head -50
        """)
    ...
    static func getWirelessInfo() -> String {
        let result = runCommand("""
        system_profiler SPNetworkDataType | grep -B2 -A2 'Wi-Fi\\|AirPort' | grep -E '(Type:|Hardware:|BSD Name:|State:|Supported PHY Modes:)' | head -15
        """)
        ...
        networksetup -listallhardwareports | grep -A2 'Wi-Fi\\|AirPort'
        """)
    ...
    static func getUSBXHCInfo() -> String {
        let result = runCommand("""
        ioreg -p IODeviceTree -n XHC -r | grep -i 'model\\|name\\|vendor-id\\|device-id' | head -10
        """)
        ...
        system_profiler SPUSBDataType | grep -i 'xhci\\|extensible' | head -5
        """)
...
// MARK: - Data Models (from original code)
...
// MARK: - Reusable Components (from original code)
...
struct ExportSystemInfoView: View {
                ...
                VStack(spacing: 20) {
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Toggle("Hardware Details", isOn: $includeHardware)
    ...
    private func generatePreview() -> String {
        ...
        content += "CPU: \(systemInfo.processor) (\(systemInfo.processorDetails))\n"
        content += "RAM: \(systemInfo.memory)\n"
        content += "Boot: \(systemInfo.bootMode)\n"
        
        if includeHardware {
            content += "\n=== Hardware Summary ===\n"
            content += "GPU: \(systemInfo.gpuInfo.components(separatedBy: "\n").first ?? "Unknown")\n"
            content += "Network: Detected\n"
            content += "Storage: Multiple controllers\n"
            content += "USB: XHCI controller detected\n"
        }
    ...
    private func generateJSON() -> String {
        ...
        json["system"] = [
            ...
            "processorDetails": systemInfo.processorDetails,
            "memory": systemInfo.memory,
            "bootMode": systemInfo.bootMode,
            "systemUUID": systemInfo.systemUUID,
            "platformUUID": systemInfo.platformUUID,
            "serialNumber": systemInfo.serialNumber,
            "bootROMVersion": systemInfo.bootROMVersion,
            "smcVersion": systemInfo.smcVersion,
        ...
        if includeHardware {
            json["hardware"] = [
                ...
                "network": systemInfo.networkInfo,
                "wireless": systemInfo.wirelessInfo,
                "storage": systemInfo.storageInfo,
                "usb": systemInfo.usbInfo,
                "usbXHC": systemInfo.usbXHCInfo,
                "thunderbolt": systemInfo.thunderboltInfo,
                "ethernet": systemInfo.ethernetInfo,
                "nvme": systemInfo.nvmeInfo,
                "ahci": systemInfo.ahciInfo,
                "audio": systemInfo.audioInfo,
                "bluetooth": systemInfo.bluetoothInfo,
                "pci": systemInfo.pciDevices
            ]
        }
    ...
    private func generateHTML() -> String {
        ...
        <html>
        <head>
            <title>SystemMaintenance Complete Report</title>
            <style>
                body { 
            ...
            <div class="container">
                <div class="header">
                    <div>
                        ...
                        <div class="logo">Complete Hardware & System Analysis</div>
                    </div>
                    <div>
                ...
                <div class="section">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            <div class="label">Processor Details</div>
                            <div class="value">\(systemInfo.processorDetails)</div>
                        </div>
                        <div class="info-item">
                        ...
                        <div class="info-item">
                            <div class="label">System UUID</div>
                            <div class="value">\(systemInfo.systemUUID)</div>
                        </div>
                        <div class="info-item">
                            <div class="label">Serial Number</div>
                            <div class="value">\(systemInfo.serialNumber)</div>
                        </div>
                        <div class="info-item">
                            <div class="label">Boot ROM Version</div>
                            <div class="value">\(systemInfo.bootROMVersion)</div>
                        </div>
                        <div class="info-item">
                            <div class="label">SMC Version</div>
                            <div class="value">\(systemInfo.smcVersion)</div>
                        </div>
                        <div class="info-item">
                ...
                <div class="section">
                    ...
                    <div class="hardware-info">\(systemInfo.gpuInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- Network Information -->
                <div class="section">
                    <h2>🌐 Network Information</h2>
                    <div class="hardware-info">\(systemInfo.networkInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- Wireless Network Controller -->
                <div class="section">
                    <h2>📡 Wireless Network Controller</h2>
                    <div class="hardware-info">\(systemInfo.wirelessInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- Storage Controllers -->
                <div class="section">
                    <h2>💾 Storage Controllers</h2>
                    <div class="hardware-info">\(systemInfo.storageInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- USB Information -->
                <div class="section">
                    <h2>🔌 USB Information</h2>
                    <div class="hardware-info">\(systemInfo.usbInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- USB eXtensible Host-Controller -->
                <div class="section">
                    <h2>⚡ USB eXtensible Host-Controller (XHC)</h2>
                    <div class="hardware-info">\(systemInfo.usbXHCInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- Thunderbolt Information -->
                <div class="section">
                    <h2>⚡ Thunderbolt Information</h2>
                    <div class="hardware-info">\(systemInfo.thunderboltInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- Ethernet Controller -->
                <div class="section">
                    <h2>🔗 Ethernet Controller</h2>
                    <div class="hardware-info">\(systemInfo.ethernetInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- NVMe Controller -->
                <div class="section">
                    <h2>🚀 NVMe Controller</h2>
                    <div class="hardware-info">\(systemInfo.nvmeInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- AHCI/SATA Controller -->
                <div class="section">
                    <h2>🔧 AHCI/SATA Controller</h2>
                    <div class="hardware-info">\(systemInfo.ahciInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- Audio Information -->
                <div class="section">
                    <h2>🎵 Audio Information</h2>
                    <div class="hardware-info">\(systemInfo.audioInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- Bluetooth Information -->
                <div class="section">
                    <h2>📱 Bluetooth Information</h2>
                    <div class="hardware-info">\(systemInfo.bluetoothInfo.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
                
                <!-- PCI Devices -->
                <div class="section">
                    <h2>🖥️ PCI Devices</h2>
                    <div class="hardware-info">\(systemInfo.pciDevices.replacingOccurrences(of: "\n", with: "<br>"))</div>
                </div>
    ...
    private func exportToFile() {
        ...
        // Set default file name and extension based on format
        let dateFormatter = DateFormatter()
...
// MARK: - System Maintenance View (from original code)
...
// MARK: - Kext Management View (from original code)
...
// MARK: - Audio Tools View (from original code)
