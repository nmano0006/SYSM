            ...
            <div class="container">
                ...
                <div class="section">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <div class="value \(ShellHelper.isSIPDisabled() ? "status-good" : "status-bad")">\(ShellHelper.isSIPDisabled() ? "Disabled" : "Enabled")</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="section">
                    ...
                    <div class="info-item">
                        ...
                        <div class="value \(efiPath != nil ? "status-good" : "status-warning")">\(efiPath != nil ? "Yes" : "No")</div>
                    </div>
                    \(efiPath != nil ? """
                    <div class="info-item">
...
struct KextManagementView: View {
    ...
    private func browseForKextFile() {
        ...
        panel.allowsMultipleSelection = false
        panel.allowedContentTypes = [UTType(filenameExtension: "kext") ?? .item]
